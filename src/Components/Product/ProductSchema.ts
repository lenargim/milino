...
import {settingSizesType, sizeLimitsType} from "../../helpers/productTypes";
...
//                 .min(settingMinWidth, `Min ${settingMinWidth} inches`)
//                 .max(settingMaxWidth, `Max ${settingMaxWidth} inches`)
...
//                 .min(settingMinHeight, `Min ${settingMinHeight} inches`)
//                 .max(settingMaxHeight, `Max ${settingMaxHeight} inches`)
//                 .typeError('Invalid Input: numbers please')
//                 .test(
//                     "is-decimal",
//                     "Maximum two digits after comma",
...
//                 .min(settingMinDepth, `Min ${settingMinDepth} inches`)
//                 .max(settingMaxDepth, `Max ${settingMaxDepth} inches`)
//                 .typeError('Invalid Input: numbers please')
//                 .test(
//                     "is-decimal",
//                     "Maximum two digits after comma",
